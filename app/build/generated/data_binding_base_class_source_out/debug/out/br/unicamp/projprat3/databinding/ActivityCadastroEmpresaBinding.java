...
public final class ActivityCadastroEmpresaBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCadastroEmpresaBinding(@NonNull RelativeLayout rootView,
      @NonNull Button btnContinuar, @NonNull TextView cadastro, @NonNull TextView cnpj,
      ...
      @NonNull TextView senha, @NonNull TextView telefone) {
  ...
  @NonNull
  public static ActivityCadastroEmpresaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCadastroEmpresaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_cadastro_empresa, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCadastroEmpresaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCadastroEmpresaBinding((RelativeLayout) rootView, btnContinuar, cadastro,
          cnpj, edtCnpj, edtEmail, edtEndereco, edtNome, edtSenha, edtTelefone, email, endereco,
          nome, senha, telefone);
    }
